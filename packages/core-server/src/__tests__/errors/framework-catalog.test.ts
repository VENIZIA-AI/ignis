...
import { RepositoryErrors } from '@venizia/ignis-kernel';
import { AuthenticationErrors } from '@venizia/ignis-kernel';
import { AuthorizationErrors } from '@venizia/ignis-kernel';
import { MailErrors } from '@/components/mail/common';
import { StaticAssetErrors } from '@/components/static-asset/common';
import { SearchErrors } from '@venizia/ignis-connectors/search';
...
const PINNED = [
  ...
  'core.authentication.service.assertion_missing',
  'core.authentication.service.assertion_invalid',
  'core.authentication.service.caller_not_allowed',
  'core.authentication.service.request_binding_mismatch',
  'core.authentication.service.principal_unresolved',
  ...
  'core.static_asset.upload_not_authorized',
