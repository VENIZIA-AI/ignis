...
import {
  ...
  ISearchQueryDialect,
} from '@venizia/ignis-connectors/search';
import { ICrudRepository } from '@venizia/ignis-kernel';
import { TypesenseQueryDialect } from '@venizia/ignis-connectors/typesense';
