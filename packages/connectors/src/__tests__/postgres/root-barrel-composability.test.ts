...
import type { TSoftDeletableTableSchema, TTableInsert, TTableObject } from '@/relational/postgres';
import { SoftDeletableRepository } from '@/relational/postgres';
...
/**
 * `@/relational/postgres` re-exports the Postgres tier, so the `TSoftDeletableTableSchema` it serves must
