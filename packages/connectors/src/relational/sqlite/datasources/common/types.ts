...
import type { IRelationalQueryDialect } from '@/relational/core/repositories/common';
 ...
 * and naming its type here would make the `@venizia/ignis-connectors/sqlite` declarations unusable
 * without it.
 */
