...
import type { ITransformedUpdateData } from '@/relational/core/repositories/common';
import { TableColumnCache } from '@/relational/core/repositories/common';
...
export class SqliteUpdateBuilder extends RelationalUpdateBuilder {
  ...
  override transform<Schema extends TTableSchemaWithId>(opts: {
    ...
    const columns = TableColumnCache.get(schema);
